...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Thêm nhóm default user</title>
            ...
            <div id="main-content">
                ...
                <ul class="shortcut-buttons-set">
                    <?php if (verify_access_right(current_account(), F_SETTINGS_DEFAULT_USER)) : ?>
                        ...
                        <li>
                            <a class="shortcut-button add-freelancer current" href="../settings/default_users_add.php">
                ...
                <div class="content-box column-left" style="width:100%"><!-- Start Content Box -->
                    <div class="content-box-header">
                        <h3>Thêm default user</h3>
                    </div>
                    <div class="content-box-content">
                        <div class="tab-content default-tab">
                            <form id="create_default_user" action="" method="post">
                                <?php
                                ...
                                if (isset($_POST['create'])) {
                                    ...
                                    if ($done) {
                                        ...
                                        // Add account item
                                        $u = new default_users_entity();
                                        $u->account_id = $account_id;
                                        $u->password = md5($password);
                                        $u->enable = $enable;
                                        $done = $users_model->insert($u);
                                        if ($done) {
                                            foreach ($stores as $s) {
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="account_id" id="account_id" autocomplete="off" class="text-input small-input" maxlength="50" value="" />
                                ...
                                <fieldset id="control_panel">
                                    <p>
                                        <input type="submit" class="button" value="Tạo" name="create">
