...
// Authenticate
do_authenticate(G_REPORT, F_REPORT_RPT_BY_EMPLOYEE, TRUE);
?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Tổng hợp theo nhân viên bán hàng</title>
            ...
            <div id="main-content">
                ...
                <div class="content-box column-left" style="width:100%">
                    <div class="content-box-header">
                        <h3>Tổng hợp theo nhân viên bán hàng</h3>
                    </div>
                                            ...
                                            <div id="demo">
                                                ...
                                                <table class="bordered" id="example">
                                                    ...
                                                    <tbody>
                                                        <?php 
                                                        $nv = new nhanvien();
                                                        $array = $nv->employee_list();
                                                        
                                                        foreach ($array as $row) {
                                                            $dh = new donhang();
                                                            $revenue = $dh->tong_hop_theo_nhan_vien($row['manv'], $year);
                                                            echo "<tr>";
