...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Assign coupon cho khách hàng giới thiệu</title>
        ...
        <div id="body-wrapper">
            ...
            <div id="main-content">
                ...
                <ul class="shortcut-buttons-set">
                    <li>
                        <a class="shortcut-button upload-image" href="../coupon/third-used-list.php">
                            <span class="png_bg">Danh sách coupon giới thiệu</span>
                        </a>
                    </li>
                </ul>
                <div class="content-box column-left" style="width:100%">
                    <div class="content-box-header">
                        <h3>Assign coupon cho khách hàng giới thiệu</h3>
                    </div>
                        ...
                        <div class="tab-content default-tab">
                            <form id="assign_coupon" action="" method="post">
                                ...
                                if (isset($_POST["assign"]))
                                {
                                    ...
                                    $coupon = new coupon();
                                    $done = $coupon->assign_new($assign_to, $bill_code, $group_id, COUPON_ASSIGN_GUEST_THIRD_USED, $amount, TRUE);
                                    
                                    $third_used = new coupon_third_used();
                                    $third_used->update_assigned($coupon_code, 1);
                                }
                                ?>
                                ...
                                <div id="coupon_info" class="notification information png_bg">
                                    ...
                                    <div>
                                        <label>Khách hàng giới thiệu</label>
