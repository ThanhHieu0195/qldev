...
// Authenticate
do_authenticate(G_REWARDS_PENALTY, F_REWARDS_PENALTY_ASSIGNED_LIST, TRUE);
?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Danh sách ghi nhận về bạn</title>
        ...
        <script type="text/javascript" charset="utf-8">
            $(function() {
                var oTable = $('#example').dataTable( {
                    ...
                    "bServerSide": true,
                    "bPaginate": true,
                    "sAjaxSource": "../ajaxserver/rewards_assigned_list_server.php?top_days=<?php if (isset($_GET['top_days'])) echo $_GET['top_days']; ?>",
                    "aaSorting": [[ 1, "desc" ]],
                    "aoColumnDefs": [
                        { "sClass": "center", "aTargets": [2] }
                    ],
                    "fnRowCallback": function( nRow, aData, iDisplayIndex ) {
                        $('td:eq(0)', nRow).html(String.format("<a href='../rewards_penalty/detail.php?i={0}' id='div{1}'>{2}</a>", aData[5], iDisplayIndex, aData[0]));
            ...
            <div id="main-content">
                ...
                <ul class="shortcut-buttons-set">
                    ...
                    <?php if (verify_access_right(current_account(), F_REWARDS_PENALTY_ASSIGNED_LIST)): ?>
                        <li>
                            <a class="shortcut-button unevaluated current" href="assigned-list.php">
                ...
                <div class="content-box column-left" style="width:100%">
                    <div class="content-box-header">
                        <h3>Danh sách ghi nhận về bạn</h3>
                    </div>
