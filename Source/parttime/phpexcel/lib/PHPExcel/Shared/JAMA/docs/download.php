...
if($_GET['op'] == "download") {  
	...
	require_once('../../../../../../lib/PHPExcel/Shared/JAMA/docs/Archive/Tar.php');  
...
<ul>
 <li><a href='<?php echo $_SERVER['../../../../../../lib/PHPExcel/Shared/JAMA/docs/PHP_SELF']."?op=download"; ?>'><?php echo $tarName ?></a></li>
</ul>
<?php
