...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Danh sách loại chi phí</title>
        ...
        <script type="text/javascript" charset="utf-8">
            $(function() {
                var oTable = $('#example').dataTable( {
                    ...
                    "bServerSide": true,
                    "bPaginate": true,
                    "sAjaxSource": "../ajaxserver/finance_category_list_server.php",
                    "aoColumnDefs": [
                        { "sClass": "center", "aTargets": [2, 3] },
                        { bSortable: false, aTargets: [] } // <-- gets these column(s) and turns off sorting
                    ],
                    "fnRowCallback": function( nRow, aData, iDisplayIndex ) {
                        $('td:eq(0)', nRow).html(String.format("<a title='Chi tiết' href='../finance/category-detail.php?i={0}'>{1}</a>", aData[0], aData[0]));
            ...
            <div id="main-content">
                ...
                <ul class="shortcut-buttons-set">
                    <?php if (verify_access_right(current_account(), F_SYSTEM_ADMIN_FINANCE)): ?>
                        ...
                        <li>
                            <a class="shortcut-button switch current" href="../finance/category-list.php">
                ...
                <div class="content-box column-left" style="width:100%">
                    <div class="content-box-header">
                        <h3>Danh sách loại chi phí</h3>
                    </div>
                    <div class="content-box-content">
                        <div class="tab-content default-tab">
                            <a class="blue-text" href="../finance/category-add.php" title="Thêm mới">
