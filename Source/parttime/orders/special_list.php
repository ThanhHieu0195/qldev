...
// Authenticate
do_authenticate(G_ORDERS, F_ORDERS_SPECIAL_LIST, TRUE);
?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Đơn hàng cần theo dõi đặc biệt</title>
        ...
        <script type="text/javascript" charset="utf-8">
            $(function() {
                ...
                var oTable = $('#example').dataTable( {
                    "bProcessing": true,
                    "bServerSide": true,
                    "sAjaxSource": "../ajaxserver/special_list_server.php",
            ...
            <div id="main-content">
                ...
                <ul class="shortcut-buttons-set">
                    <?php if (verify_access_right(current_account(), F_ORDERS_SUPPORT_LIST)): ?>
                        <li>
                            <a class="shortcut-button add-event" href="support_list.php">
                    ...
                    <?php if (verify_access_right(current_account(), F_ORDERS_SPECIAL_LIST)): ?>
                        <li>
                            <a class="shortcut-button new-page current" href="special_list.php">
                ...
                <div class="content-box column-left" style="width:100%">
                    <div class="content-box-header">
                        <h3>Đơn hàng cần theo dõi đặc biệt</h3>
                    </div>
                    <div id="dt_example">
                        <div id="container">
                            <div id="demo">
