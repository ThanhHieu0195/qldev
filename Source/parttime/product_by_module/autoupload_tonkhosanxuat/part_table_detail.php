<?php 
$title = "Thêm tồn kho sản xuất từ Excel";
 ...
 <div class="content-box column-left" style="width:100%">
    ...
    <div class="content-box-content" >
        <form action="ajaxserver.php?action=autoupload_tonkhosanxuat" method="post" enctype="multipart/form-data" target="hidden_upload">
            <p>     
            ...
            <p>
                <a href="../uploads/templates/template_autoupload_tonkhosanxuat.xls">teamplate</a>
            </p>
            <p>
