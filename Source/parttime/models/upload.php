    ...
    {    
        ...
        if($data != NULL)
        {
            ...
            foreach($data as $row)
            {
                ...
                $cao       = $row['cao'];       // chieu rong
                $giavon    = $row['giavon'];     // gia ban
                ...
                if($obj->result)
                {
                    ...
                    {
                        if($tranh->them($masotranh, $tentranh, $maloai, $cao, $dai, $rong, $giavon, $giaban, $matho, $ghichu, $hinhanh, $tongmau, $hoavan, $loai))
                        {
                            $done = FALSE;
