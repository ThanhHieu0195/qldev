<?php
	 ...
	 */
	$aColumns = array('cv.id', 'idhangmuc', 'tenhangmuc', 'mota', 'motacongviec', 'tieuchihoanthanh');
	
	/* Indexed column (used for fast and accurate table cardinality) */
	$sIndexColumn = "cv.id";
	
	/* DB table to use */
	$sTable = "congviechangmucthicong cv join hangmucthicong hm on cv.idhangmuc = hm.id ";
