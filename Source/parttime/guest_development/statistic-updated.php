...
// Authenticate
do_authenticate(G_GUEST_DEVELOPMENT, F_GUEST_DEVELOPMENT_STATISTIC_UPDATED, TRUE);
?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Thống kê danh sách khách hàng được update</title>
        <?php 
            ...
            <div id="main-content">
                ...
                <ul class="shortcut-buttons-set">
                    <?php if (verify_access_right(current_account(), F_GUEST_DEVELOPMENT_STATISTIC_UPDATED)): ?>
                        <li>
                            <a class="shortcut-button on-going current" href="../guest_development/statistic-updated.php">
                ...
                <div class="content-box column-left" style="width:100%">
                    <div class="content-box-header">
                        <h3>Thống kê danh sách khách hàng được update</h3>
                    </div>
                    <div class="content-box-content">
                        <div class="tab-content default-tab">
                            <form action="" method="get">
                                ...
                                <div>
                                    <a class="blue-text" href="javascript:statisticUpdated();" title="Thống kê">
                                        <img width="24px" src="../resources/images/icons/outgoing_32.png" alt="statistic">
                                        Thống kê
                                    </a>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <a class="blue-text" href="javascript:exportExcel('updated');" target="blank" title="Export file Excel">
