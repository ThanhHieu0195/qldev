...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Tạo câu hỏi kiểm tra đơn hàng</title>
        ...
        <div id="body-wrapper">
            ...
            <div id="main-content">
                ...
                <ul class="shortcut-buttons-set">
                    <li>
                        <a class="shortcut-button add current" href="../orders/question.php">
                ...
                <div class="content-box column-left" style="width:100%">
                    ...
                    <div class="content-box-content">
                        <div class="tab-content default-tab" style="display: block;">
                            <form id="create_template" action="../ajaxserver/orders_create_question.php" method="post" target="hidden_upload">
                                <table>
                                    <tbody>
                                        <tr>
                                            <td width="20%">                            
                                ...
                                <fieldset>
                                    <p>
                                        <input type="submit" class="button" value="Tạo câu hỏi" name="create_question" />
