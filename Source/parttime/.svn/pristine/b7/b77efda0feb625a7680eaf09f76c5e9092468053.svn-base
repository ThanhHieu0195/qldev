<?php
	 ...
	 */
	$aColumns = array('dsncc.id', 'ten', 'diachi', 'dienthoai', 'idhangmuc', 'tenhangmuc', 'manhacc');
	$bcolumns = array('id', 'ten', 'diachi', 'dienthoai', 'idhangmuc', 'manhacc');
	
	/* Indexed column (used for fast and accurate table cardinality) */
	$sIndexColumn = "dsncc.idhangmuc";
	
	/* DB table to use */
	$sTable = "danhsachnhacungcap dsncc join hangmucthicong hm on dsncc.idhangmuc = hm.id ";
