                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                        ...
                        <?php
                           ...
                           foreach ($data_detail as $obj):
                                ...
                                $auto_money = $obj['khoiluongthucte']*$obj['dongiathdutoan']; 
                                $khoiluongthucte = "<input type='text' value='".$obj['khoiluongthucte']."' name='khoiluongthucte".$token."' placeholder='0' price_expect='".$obj['dongiathdutoan']."' onkeyup='calautoExpectMoney(\"".$token."\")'>";
                                $chiphithucte = "<input type='text' name='chiphithucte".$token."' onkeyup='formatExpectMoney(\"$token\")' value='".number_2_string($auto_money)."'>";
                                $khoiluongdutoan = number_2_string($obj['khoiluongdutoan']);
                                $group_category = $obj['nhom'];
                                $mdutoan = number_2_string($obj['dudoanchiphibandau']);
                                ...
                                $row .= "<td>$khoiluongdutoan</td> <td>$mdutoan</td> <td>$khoiluongthucte</td><td>$chiphithucte</td> <td>$ghichu</td><td>$function</td> </tr>";
                                echo $row;
                                $i++;
                            endforeach;
                         ?>
