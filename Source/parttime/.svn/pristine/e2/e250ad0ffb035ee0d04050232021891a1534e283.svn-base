                    ...
                    <div class="content-box-content">
                        ...
                        <div class="tab-content default-tab">
                            <form id="add-product" action="" method="post">
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <input id="product_id" name="product_id" class="text-input small-input" maxlength="50" type="text" readonly="readonly" value="<?php echo create_uid(FALSE); ?>" />
                                ...
                                <fieldset>
                                    <p>
                                        <input class="button" type="submit" name="save" value="Thêm sản phẩm" />
                                    </p>
                                </fieldset>
                            </form>
                        </div>
