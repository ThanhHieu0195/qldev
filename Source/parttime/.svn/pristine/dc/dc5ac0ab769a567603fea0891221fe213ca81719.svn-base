<?php
	...
	$aColumns = array("kq.id", "kq.macongviec", "cv.mota", "nv.hoten", "a.ngaynopbai", "kq.giatien", "kq.trangthai", "'' chucnang" );

	$sIndexColumn = "kq.trangthai";
	
	/* DB table to use */
	$sTable = "ketquacongtac kq inner join approvecongviec a on kq.macongviec = a.idcongviec
								inner join congvieccongtac cv on cv.id = kq.macongviec
								inner join nhanvien nv on nv.manv = kq.manv";
