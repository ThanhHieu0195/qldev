    ...
    <script type="text/javascript">
          $(function() {
            var oTable = $('#example').dataTable( {
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "../ajaxserver/list_building_server_wait_for_real_data.php",
                "aoColumnDefs": [
                ...
                "fnRowCallback": function( nRow, aData, iDisplayIndex ) {
                    ...
                    $('td:eq(8)', nRow).html("<a href='detail_building_realdata.php?token_id="+aData[0]+"' target='blank'>Chi tiết</a>");
                }
            });
        });
    </script>
