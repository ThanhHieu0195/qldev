...
// Authenticate
do_authenticate(G_REWARDS_PENALTY, F_REWARDS_PENALTY_CREATED_LIST, TRUE);
?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Danh sách ghi nhận bạn đã tạo</title>
        ...
        <script type="text/javascript" charset="utf-8">
            $(function() {
                var oTable = $('#example').dataTable( {
                    ...
                    "bServerSide": true,
                    "bPaginate": true,
                    "sAjaxSource": "../ajaxserver/rewards_created_list_server.php?top_days=<?php echo $_GET['top_days']; ?>",
                    "aaSorting": [[ 1, "desc" ]],
                    "aoColumnDefs": [
            ...
            <div id="main-content">
                ...
                <ul class="shortcut-buttons-set">
                    <?php if (verify_access_right(current_account(), F_REWARDS_PENALTY_CREATED_LIST)): ?>
                        <li>
                            <a class="shortcut-button finished current" href="created-list.php">
                ...
                <div class="content-box column-left" style="width:100%">
                    <div class="content-box-header">
                        <h3>Danh sách ghi nhận bạn đã tạo</h3>
                    </div>
