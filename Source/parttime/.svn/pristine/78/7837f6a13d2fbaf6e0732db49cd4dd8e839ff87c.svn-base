...
// Authenticate
do_authenticate(G_GUEST_DEVELOPMENT, F_GUEST_DEVELOPMENT_REVENUE, TRUE);
?>
...
left join khachguicatalog kg on kg.makhach = k.makhach
...
order by total desc;
                                ...
                                if(is_array($arr)):
                                    ...
                                    if ($item['vip']=='') {
                                        $row .= "<td><div id='khach_".$item['makhach']."'> <button type='button' onclick='themkhachvip(this);' value='" . $item['makhach'] . "'>Them</button> </div></td>";
                                    } else {$row .= "<td></td>";}
                                    $row .= "</tr>";
                                    echo $row;
                                    $i++;
