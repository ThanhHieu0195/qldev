...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Tổng hợp điểm số trung bình</title>
        <?php 
        ...
        <script type="text/javascript" src="../resources/scripts/utility/task-average-list.js"></script>
        ...
        <script type="text/javascript" charset="utf-8">
            ...
            <?php if(isset ($_REQUEST['view'])): ?>
                $('#example1').dataTable({
                    ...
                    "bFilter": false,
                    "bServerSide": true,
                    "sAjaxSource": "../ajaxserver/task_average_list_server.php?from=<?php echo $_REQUEST['tungay']; ?>&to=<?php echo $_REQUEST['denngay']; ?>",
        ...
        <div id="body-wrapper">
            ...
            <div id="main-content">
                ...
                <ul class="shortcut-buttons-set">
                    <li>
                        <a class="shortcut-button sum" href="statistic-list.php">
                            <span class="png_bg">Tổng điểm</span>
                        </a>
                    </li>
                    <li>
                        <a class="shortcut-button average current" href="average-list.php">
                ...
                <div class="content-box column-left" style="width:100%">
                    <div class="content-box-header">
                        <h3>Tổng hợp điểm số trung bình</h3>
                    </div>
                    <div class="content-box-content">
                        <div class="tab-content default-tab">
                            <form id="task-average-list" action="" method="get">
                                <div>
