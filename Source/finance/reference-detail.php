...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Cập nhật số tham chiếu</title>
                ...
                <div class="content-box column-left" style="width:100%">
                    ...
                    <div class="content-box-content">
                        ...
                        <div class="tab-content default-tab">
                            <?php 
                                $reference_id = (isset($_GET['i'])) ? $_GET['i'] : '';
                                
                                // Get detail of role group
                                $model = new finance_reference();
                                $reference = $model->detail($reference_id);
                            ?>
                            <?php if ($reference != NULL): ?>
                                <form id="edit-reference" action="" method="post">
                                    <?php
                                        if (isset($_POST["save"])) {
                                            ...
                                            $item = $model->detail($reference_id);
                                            if ($item != NULL) {
                                                $item->name = $name;
                                                $item->enable = $enable;
                                                ...
                                                $result = FALSE;
                                                $message = "Không tìm thấy thông tin chi tiết số tham chiếu '{$reference_id}'";
                                            }
                                    ...
                                    <table>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <input id="reference_id" name="reference_id" class="text-input small-input" maxlength="50" type="text" readonly="readonly" value="<?php echo $reference->reference_id; ?>" />
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input id="name" name="name" class="text-input medium-input" type="text" value="<?php echo $reference->name; ?>" />
                                                    <img class="error_icon" src="../resources/images/icons/cross_circle.png" alt="" />
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <select name="used_type" id="used_type">
                                                        <?php 
                                                            ...
                                                            foreach ($types as $t):
                                                        ?>
                                                                <option value="<?php echo $t; ?>" <?php echo ($t == $reference->used_type) ? "selected='selected'" : ""; ?> ><?php echo get_finance_type_name($t); ?></option>
                                                        <?php
                                                            endforeach;
                                                        ?>
                                                    </select>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="checkbox" name="enable" <?php echo ($reference->enable == BIT_TRUE) ? "checked='checked'" : "" ?> alt=""> Yes
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <fieldset>
                                        <p>
                                            <input class="button" type="submit" name="save" value="Cập nhật số tham chiếu" />
                                        </p>
                                    </fieldset>
                                </form>
                            <?php endif; ?>
