...
// Authenticate
do_authenticate(G_GUEST_DEVELOPMENT, F_GUEST_DEVELOPMENT_LIST_CANCELLED, TRUE);
?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Danh sách khách hàng không cần theo dõi nữa</title>
        ...
        <script type="text/javascript" charset="utf-8">
            $(function() {
                var oTable = $('#example').dataTable( {
                    ...
                    "bServerSide": true,
                    "bPaginate": true,
                    "sAjaxSource": "../ajaxserver/guest_development_list_cancelled_server.php",
                    "aoColumnDefs": [
                    ...
                    "fnRowCallback": function( nRow, aData, iDisplayIndex ) {
                        ...
                        $('td:eq(6)', nRow).html(String.format("&nbsp; <a target='_blank' title='Lịch sử liên hệ' href='../guest_development/contact.php?i={0}#history'><img src='../resources/images/icons/contact-16.png' alt='' /></a>", aData[6]));
                    }
                });
            });
        </script>
            ...
            <div id="main-content">
                ...
                <ul class="shortcut-buttons-set">
                    ...
                    <?php if (verify_access_right(current_account(), F_GUEST_DEVELOPMENT_LIST_CANCELLED)): ?>
                        <li>
                            <a class="shortcut-button switch current" href="../guest_development/list-cancelled.php">
                ...
                <div class="content-box column-left" style="width:100%">
                    <div class="content-box-header">
                        <h3>Danh sách khách hàng không cần theo dõi nữa</h3>
                    </div>
