...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Danh sách nhóm nhân viên</title>
            ...
            <div id="main-content">
                ...
                <ul class="shortcut-buttons-set">
                    <?php if (verify_access_right(current_account(), F_EMPLOYEES_EMPLOYEE_GROUP)) : ?>
                        <li>
                            <a class="shortcut-button employee current" href="../employees/employee_group_list.php">
                                    ...
                                    <div id="demo">
                                        <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                                            ...
                                            <tbody>
                                                ...
                                                $groups = $group_model->list_group(TRUE);
                                                foreach ($groups as $g):
                                                    $members = $members_model->list_members_of_group($g->group_id, TRUE);
                                                ?>
                                                    <tr>
                                                        <td>
                                                            <a title="Chi tiết" href="../employees/employee_group_detail.php?i=<?php echo $g->group_id; ?>"><?php echo $g->group_name; ?></a>
                                                        </td>
                                                        <td>
                                                            <?php if ($g->enable): ?>
