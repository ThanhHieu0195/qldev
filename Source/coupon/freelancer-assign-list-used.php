...
// Authenticate
do_authenticate(G_COUPON, F_COUPON_FREELANCER_USED, TRUE);
?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Danh sách coupon đã sử dụng</title>
        <?php 
            ...
            <div id="main-content">
                ...
                <script type="text/javascript" charset="utf-8">
                        $(function() {
                            var oTable = $('#example').dataTable( {
                                ...
                                "bServerSide": true,
                                "bPaginate": false,
                                "sAjaxSource": "../ajaxserver/assign_freelancer_list_by_type_server.php?id=<?php echo current_account(UID); ?>&type=used",
                                "aoColumnDefs": [
                ...
                <div class="content-box column-left" style="width:100%">
                    <div class="content-box-header">
                        <h3>Danh sách coupon đã sử dụng</h3>
                    </div>
