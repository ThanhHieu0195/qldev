...
// Authenticate
do_authenticate(G_COUPON, F_COUPON_FREELANCER_EXPIRED, TRUE);
?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Danh sách coupon hết hạn</title>
        <?php 
            ...
            <div id="main-content">
                ...
                <script type="text/javascript" charset="utf-8">
                        $(function() {
                            var oTable = $('#example').dataTable( {
                                ...
                                "bServerSide": true,
                                "bPaginate": false,
                                "sAjaxSource": "../ajaxserver/assign_freelancer_list_by_type_server.php?id=<?php echo current_account(UID); ?>&type=expired",
                                "aoColumnDefs": [
                                ...
                                "fnRowCallback": function( nRow, aData, iDisplayIndex ) {
                                    ...
                                    $('td:eq(4)', nRow).html("<span class='orange'>" + Math.abs(aData[5]) + "</span>");
                                }
                            });
                        });
                </script>
                <div class="content-box column-left" style="width:100%">
                    <div class="content-box-header">
                        <h3>Danh sách coupon hết hạn</h3>
                    </div>
