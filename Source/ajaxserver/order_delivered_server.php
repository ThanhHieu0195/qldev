<?php
	 ...
	 */
	$aColumns = array( 'donhang.madon', 'khach.hoten', 'nhomkhach.tennhom', 'donhang.ngaydat', 'donhang.ngaygiao', 'donhang.hoa_don_do', 
	                   'donhang.thanhtien', 'donhang.assign_coupon', 'donhang.madon AS sanpham'
					  );
	...
	if ( isset($_GET['sSearch']) && $_GET['sSearch'] != "" )
	{
		...
		$sWhere .= ')';
        $sWhere .= sprintf(" AND (trangthai = '%s') AND (approved = '%s')", donhang::$DA_GIAO, donhang::$APPROVED);
	}
    ...
    if ( $sWhere == "" )
        $sWhere = sprintf("WHERE (trangthai = '%s') AND (approved = '%s')", donhang::$DA_GIAO, donhang::$APPROVED);
