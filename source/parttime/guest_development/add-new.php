        ...
        <script type="text/javascript">
            ...
            $(function() {
                ...
                $( "#dienthoai" ).click(function () {
                    if ($( "#search_guest" ).val() != "") {
                        $( "#dienthoai" ).val($( "#search_guest" ).val());
                    }
                }); 
                // autocomplete
                $( "#search_guest" ).autocomplete({
                    ...
                    select: function( event, ui ) {
                        $( "#search_guest" ).val('');
                        $( "#hoten" ).val( ui.item.hoten );

                        $( "#guest_id" ).val( ui.item.makhach );
                        $( "#search_guest_type" ).val( ui.item.nhomkhach );

                        $( "#makhach" ).html( ui.item.makhach );

                        $("#dienthoai1").val(ui.item.dienthoai1);
                        $("#dienthoai2").val(ui.item.dienthoai2);
                        $("#dienthoai3").val(ui.item.dienthoai2);

                        $( "#nhomkhach" ).val( ui.item.nhomid );
                        $( "#diachi" ).val( ui.item.diachi );
                        $( "#email" ).val( ui.item.email );
                        $( "#emailphu" ).val( ui.item.emailphu );
                        return false;
                    }
                })
        ...
        <div id="body-wrapper">
            ...
            <div id="main-content">
                ...
                <ul class="shortcut-buttons-set">
                    <li>
                        <a class="shortcut-button add current" href="../guest_development/add-new.php">
                ...
                <div class="content-box column-left" style="width:100%">
                    <div class="content-box-header">
                        <h3>Thêm khách hàng cần phát triển</h3>
                    </div>
                    <div class="content-box-content">
                        <div class="tab-content default-tab" style="display: block;">
                            <form id="add_new" action="../ajaxserver/guest_development.php" method="post" target="hidden_upload">
                                <table>
                                    <tbody>
                                        <tr>
                                         <td><label>Tìm kiếm</label></td>
                                         <td><input type="text" class="text-input small-input" name="search_guest" id="search_guest" /></td>
                                        </tr>
                                       ...
                                       <tr>
                                            <td>
                                                <span class="bold">Chiến dịch</span>
                                            </td>
                                            <td>
                                                <input type="text" class="text-input small-input" name="chiendich" id="chiendich" value="Khách hàng liên hệ qua điện thoại" />
                                                <span class="error_icon input-notification error png_bg" title="Dữ liệu không hợp lệ"></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="text-input medium-input" name="diachi" id="diachi" value="" />
                                                <span class="error_icon input-notification error png_bg" title="Dữ liệu không hợp lệ"></span>
                                            </td>
                                        </tr>
                                      <?php  
                                      ...
                                      ?>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="text-input small-input" name="dienthoai1" id="dienthoai1" value="<?php echo $phone; ?>" />
                                                <span class="error_icon input-notification error png_bg" title="Dữ liệu không hợp lệ"></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="text-input small-input" name="dienthoai2" id="dienthoai2" value="" />
                                                <span class="error_icon input-notification error png_bg" title="Dữ liệu không hợp lệ"></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="text-input small-input" name="dienthoai3" id="dienthoai3" value="" />
                                                <span class="error_icon input-notification error png_bg" title="Dữ liệu không hợp lệ"></span>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="text-input small-input" name="emailphu" id="emailphu" value="" />
                                                <span class="error_icon input-notification error png_bg" title="Dữ liệu không hợp lệ"></span>
                                            </td>
                                        </tr>
                                        <tr>
                                ...
                                <fieldset>
                                    <p>
                                        <input type="submit" class="button" value="Thêm khách hàng" name="add_new" />
                                        <input type="submit" class="button" value="Thêm khách va dat hàng" name="add_new_buy" />
