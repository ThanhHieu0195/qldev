...
// Authenticate
do_authenticate(G_WORKING_CALENDAR, F_WORKING_CALENDAR_APPROVE_LEAVE_DAYS_CHANGE, TRUE);
?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Approve dời ngày nghỉ</title>
        <?php 
        ...
        <script type="text/javascript" src="../resources/scripts/utility/working_calendar/approve-leave-days-change.js"></script>
        ...
        <script type="text/javascript" charset="utf-8">
            $(function() {
                ...
                $('#example').dataTable({
                    ...
                    "bFilter": true,
                    "bServerSide": true,
                    "sAjaxSource": "../ajaxserver/working_calendar_leave_days_change_list_server.php",
            ...
            <div id="main-content">
                ...
                <ul class="shortcut-buttons-set">
                    ...
                    <?php if (verify_access_right(current_account(), F_WORKING_CALENDAR_APPROVE_LEAVE_DAYS_CHANGE)): ?>
                        <li>
                            <a class="shortcut-button switch current" href="../working_calendar/approve-leave-days-change.php">
                ...
                <div class="content-box column-left" style="width:100%">
                    <div class="content-box-header">
                        <h3>Approve dời ngày nghỉ</h3>
                    </div>
                    <div class="content-box-content">
                        <div class="tab-content default-tab">
                            <form id="approve-leave-days-change" action="../ajaxserver/working_calendar_approve_leave_days_change.php" method="post" target="hidden_upload">
                                <div id="dt_example">
                                    <div id="container">
                                        <div id="demo">
