...
// Authenticate
do_authenticate(G_GUEST, F_GUEST_UPLOAD, TRUE);
?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Thêm khách từ file Excel</title>
            ...
            <div id="main-content">
                ...
                <div class="content-box column-left" style="width:100%">
                    <div class="content-box-header">
                        <h3>Thêm khách từ file Excel</h3>
                    </div>
                    <div class="content-box-content">
                        <div class="tab-content default-tab">
                            <form action="../ajaxserver/guestupload.php" method="post" enctype="multipart/form-data" target="hidden_upload">
                                <p>
                                ...
                                <p>
                                    <input type="checkbox" name="ktten" value="1" checked> Kiểm tra tên khách khi upload
                                </p>
                                <p>
