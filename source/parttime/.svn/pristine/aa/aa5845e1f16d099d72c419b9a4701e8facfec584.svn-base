...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Danh sách đơn hàng chờ kiểm tra</title>
        ...
        <script type="text/javascript" charset="utf-8">
            $(function() {
                ...
                var oTable = $('#example').dataTable( {
                    "bProcessing": true,
                    "bServerSide": true,
                    "sAjaxSource": "../ajaxserver/unchecked_list_server.php",
                    ...
                    "fnRowCallback": function( nRow, aData, iDisplayIndex ) {
                        if(aData[0] == '') {
                            ...
                            $('td:eq(0)', nRow).html("<a href='../orders/checking_detail.php?item=" + aData[0] + "' id='div" + iDisplayIndex + "'>" + aData[0] + "</a>");
                            ...
                            $('td:eq(5)', nRow).html("<label style='text-align: center; color: orange;'>" + aData[4] + "</label>");
            ...
            <div id="main-content">
                ...
                <div class="content-box column-left" style="width:100%">
                    <div class="content-box-header">
                        <h3>Đơn hàng chờ kiểm tra</h3>
                    </div>
                    <div id="dt_example">
                        <div id="container">
                            <div id="demo">
                                <a class="button" href="../orders/unchecked_list_export.php">Xuất ra file Excel</a>
