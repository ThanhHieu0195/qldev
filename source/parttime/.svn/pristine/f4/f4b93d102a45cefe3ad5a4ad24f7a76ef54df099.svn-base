<?php
    ...
    $upload_id = (isset($_GET['item'])) ? $_GET['item'] : '';
    
    /* Indexed column (used for fast and accurate table cardinality) */
    $sIndexColumn = 'masotranh';
    
    /* DB table to use */
    $sTable = 'upload_detail';
    $sGroupBy = '';
