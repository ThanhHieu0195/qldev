        ...
        <script type="text/javascript" charset="utf-8">
            $(function() {
                ...
                var oTable = $('#example').dataTable( {
                    ...
                    "bServerSide": true,
                    "bPaginate": true,
                    "sAjaxSource": "../ajaxserver/guest_development_unfollow.php",
                    <?php if (verify_access_right(current_account(), F_GUEST_DEVELOPMENT_LIST_FAVOURITE)): ?>
                        "aoColumnDefs": [
                            { "sClass": "center", "aTargets": [0, 5, 6] },
                            { bSortable: false, aTargets: [ 0, 5, 6 ] } // <-- gets these column(s) and turns off sorting
                        ],
                    <?php else: ?>
                        "aoColumnDefs": [
                                         { "sClass": "center", "aTargets": [0, 5] },
                                         { bSortable: false, aTargets: [ 0, 5 ] } // <-- gets these column(s) and turns off sorting
                                     ],
                    <?php endif; ?>
                    "fnRowCallback": function( nRow, aData, iDisplayIndex ) {
                        ...
                        $('td:eq(5)', nRow).html(String.format("<a title='Cập nhật thông tin khách hàng' href='../guest_development/edit.php?i={0}'><img src='../resources/images/icons/user-edit-16.png' alt='' /></a>", aData[8])
