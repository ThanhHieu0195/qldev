<?php
	...
	$_token = $_GET['token'];
	$aColumns = array('madoithicong', 'idhangmuc', 'tenhangmuc', 'giatien');
	$bcolumns = array('madoithicong', 'idhangmuc', 'giatien');
	
	/* Indexed column (used for fast and accurate table cardinality) */
	$sIndexColumn = "madoithicong";
	
	/* DB table to use */
	$sTable = " hangmucdoithicong hmdtc inner join hangmucthicong hmtc on hmtc.id = hmdtc.idhangmuc";
	 ...
	 */
	$sWhere = "WHERE madoithicong = $_token";
