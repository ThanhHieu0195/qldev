<?php
	 ...
	 */
	$aColumns = array( 'tranh.hinhanh', 'tranh.masotranh', 'tranh.tentranh', 'loaitranh.tenloai', 'tranh.giaban', 'tonkho.soluong',
                       'tranh.masotranh', 'tonkho.makho' );
    ...
    if(isset($_GET['makho']))
        ...
        $makho = '';
    //$makho = sprintf(" AND makho = '%s'", $makho);
