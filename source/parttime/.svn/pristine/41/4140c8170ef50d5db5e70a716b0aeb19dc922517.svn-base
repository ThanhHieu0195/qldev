...
function clearFormData() {
    ...
    $("#add-dienthoai1").val($("#search_guest").val());
}
...
function addNewGuest() {
    $.ajax({
        ...
        success: function(data, textStatus) {
            ...
            if(json.result == 1) {
                $( "#tenkhach" ).html( json.hoten );
                $( "#makhach" ).html( json.makhach );
                $( "#hotenkhach" ).val( json.makhach );
                $( "#nhomkhach" ).html( json.tennhom );
                $( "#diachi" ).html( json.diachi );
            }
