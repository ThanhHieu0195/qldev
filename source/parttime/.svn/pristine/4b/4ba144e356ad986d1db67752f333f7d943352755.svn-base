...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Danh sách công việc chờ đánh giá</title>
        ...
        <script type="text/javascript" charset="utf-8">
            $(function() {
                var oTable = $('#example').dataTable( {
                    ...
                    "bServerSide": true,
                    "bPaginate": true,
                    "sAjaxSource": "../ajaxserver/task_finished_list_server.php",
                    "aaSorting": [[ 4, "asc" ]],
                    "aoColumnDefs": [
        ...
        <div id="body-wrapper">
            ...
            <div id="main-content">
                ...
                <ul class="shortcut-buttons-set">
                    ...
                    <li>
                        <a class="shortcut-button finished current" href="finished-list.php">
                ...
                <div class="content-box column-left" style="width:100%">
                    <div class="content-box-header">
                        <h3>Danh sách công việc chờ đánh giá</h3>
                    </div>
                    <div id="dt_example">
                        <div id="container">
                            <div id="demo">
