...
// Authenticate
do_authenticate(G_WORKING_CALENDAR, F_WORKING_CALENDAR_ADD_NEW, TRUE);
?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Sắp xếp lịch làm việc</title>
            ...
            <div id="main-content">
                ...
                <div class="content-box column-left" style="width:100%">
                    <div class="content-box-header">
                        <h3>Sắp xếp lịch làm việc</h3>
                    </div>
                    <div class="content-box-content">
                        <div class="tab-content default-tab">
                            <form id="add_new_calendar" action="../ajaxserver/working_calendar_add_new.php" method="post" target="hidden_upload">
                                <div>
                                    <label>Kho hàng/Chi nhánh (*)</label>
                                    <select name="branch[]" id="branch" data-placeholder=" " class="chosen-select" multiple style="width:350px;">
                                                    <option value=""></option>
                                                    <?php 
                                                ...
                                                <span class="error_icon input-notification error png_bg" id="error_branch" title="Giá trị không hợp lệ"></span>
                                                <div style="height: 10px"></div>
                                </div>
                                <div>
                                    <label>Từ ngày (*)</label>
                                    <input id="from_date" name="from_date" class="text-input small-input" style="width: 150px !important" readonly type="text" value="">
                                                <span class="error_icon input-notification error png_bg" id="error_from_date" title="Dữ liệu không hợp lệ"></span>
                                                <div style="height: 10px"></div>
                                </div>
                                <div>
                                    <label>Đến ngày (*)</label>
                                    <input id="to_date" name="to_date" class="text-input small-input" style="width: 150px !important" readonly type="text" value="">
                                                <span class="error_icon input-notification error png_bg" id="error_to_date" title="Dữ liệu không hợp lệ"></span>
                                                <div style="height: 10px"></div>
                                </div>
                                <div>
                                    <input type="submit" class="button" value="Sắp xếp lịch" name="submit" />
                                                    <input type="reset" class="button" value="Làm lại" name="reset" id="reset" />
                                                    <span id="attention" style="color: red; display: none">Có một số trường dữ liệu chưa đúng. Vui lòng kiểm tra lại!</span>
                                                    <!--<a href="#messages" rel="modal" title="Chọn nhân viên" onclick="return setInputData(&quot;a_Maxi 3_2&quot;);">
