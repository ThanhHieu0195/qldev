            ...
            <div id="main-content">
                ...
                <div class="content-box column-left" style="width:100%">
                    <div class="content-box-header">
                        <h3>Quản lý báo giá mở</h3>
                    </div>
                    <div class="content-box-content">
                        <div class="tab-content default-tab">
                            <form id="excel-export" action="baogiamo.php" method="POST">
                                <div>
                                ...
                                if (isset($_POST['thongke'])) {
                                    ...
                                    $day = date('w');
                                    $tungay = '2016-08-01';
                                    $denngay = date('Y-m-d', strtotime('+'.(6-$day).' days'));
                                } 
                                    ?>
                            <div id="dt_example">
                                <div id="container">
                                ...
                                $arri = $baogia->list_by_state(1,$tungay,$denngay,$manv);
                                $row = '<tr>';
                                if(is_array($arri)):
                                    $i = 1;
                                    foreach ($arri as $itemi):
                                            ...
                                            $row .= '<td>'.$itemi['ngaybaogia'].'</td>'.'<td>'.$itemi['hoten'].'</td><td>' . $itemi['ngaycapnhat'] . '</td>';
                                            $row .= '<td>'.$itemi['capnhat'].'</td>';
                                            $row .= '<td><button type="button" onclick="showDialog('.chr(39).$itemi['id'].chr(39).');">Đóng </button></td>';
                                            $row .= '</tr>';
                                            $i++;
                                            echo $row;
                                    endforeach; 
