...
// Authenticate
do_authenticate(G_MANAGER_BUILDING, F_STATUS_BUILDING, TRUE);
?>
<?php 
    require_once "../models/trangthaicongtrinh.php";
    $status_building = new status_building();
    ...
    if (isset($_POST['update']) && isset($_POST['id']) && isset($_POST['describe'])) {
        ...
        $status_building->update($id, $describe);
    }

    if (isset($_POST['add']) && isset($_POST['describe'])) {
        $describe = $_POST['describe'];
        $status_building->insert($describe);
    }
 ?>
...
<head>
    <title>Trạng thái công trình</title>
    ...
    <!--  -->
    <script type="text/javascript" src="../resources/scripts/utility/building/status_building.js"></script>
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        $(function() {
            var oTable = $('#example').dataTable( {
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "../ajaxserver/status_building_server.php",
                "aoColumnDefs": [
            ...
            <form id="f_edit" class="popup" method="POST">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><textarea id="fedit_describe" name="describe" type="text"/></textarea></td>
                    </tr>
                </table>
                <row style="text-align: center;">
