        ...
        <div id="body-wrapper">
            ...
            <div id="main-content">
                        ...
                        <div class="tab-content default-tab">
                            ...
                            <?php if ($news != NULL && $news->enable == BIT_TRUE): ?>
                                <div id="message-content">
                                    <span class="title"><? echo $news->title; ?></span>
                                    <div>
                                        <span class="modified">(Cập nhật lúc <? echo dbtime_2_systime($news->last_modified, 'H:i:s d/m/Y'); ?>)</span>
                                        <div style="height: 20px""></div>
                                    </div>
                                    <div><? echo $news->content; ?></div>
                                </div>
                ...
                <?php 
                    ...
                    $groups = array(
                        G_TASK, G_EQUIPMENT, G_ORDERS, G_ITEMS, G_REWARDS_PENALTY, G_WORKING_CALENDAR, G_GUEST_DEVELOPMENT
                    );
                    // Items list
                    $items = array();
                    $count = 0;
