                    ...
                    <div class="content-box-content">
                        <div class="tab-content default-tab">
                            <?php 
                                ...
                                $role = $role_group_model->detail($_GET['i']);
                            ?>
                            <?php if ($role != NULL): ?>
                                <form id="create_role" action="../ajaxserver/account_role_group_server.php" method="post" target="hidden_upload">
                                    <table>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="role_id" id="role_id" class="text-input small-input uid" maxlength="50" readonly="readonly" value="<?php echo $role->role_id; ?>" />
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="role_name" id="role_name" class="text-input medium-input" maxlength="100" 
                                                           <?php //if ($role->role_id == ROLE_ADMIN) { echo "readonly='readonly'"; } ?> value="<?php echo $role->role_name; ?>" />
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="checkbox" name="enable" <?php if ($role->enable == BIT_TRUE) { echo "checked='checked'"; } ?> /> Enable
                                                </td>
                                            </tr>
                                            <tr>
                                    ...
                                    <fieldset id="control_panel" style="display: none;">
                                        <p>
                                            <input type="submit" class="button" value="Cập nhật nhóm quyền" name="update_role">
