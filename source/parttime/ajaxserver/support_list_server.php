<?php ini_set('display_errors', 1);
    ...
    if ( isset($_GET['sSearch']) && $_GET['sSearch'] != "" )
    {
        ...
        $sWhere .= ')';
        $sWhere .= sprintf(" AND (support = '%s') AND (approved = '%s')", donhang::$SUPPORT_NEED, donhang::$APPROVED);
    }
    ...
    if ( $sWhere == "" )
        $sWhere = sprintf("WHERE (support = '%s') AND (approved = '%s')", donhang::$SUPPORT_NEED, donhang::$APPROVED);
