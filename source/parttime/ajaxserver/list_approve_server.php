<?php
	 ...
	 */
	$aColumns = array( "a.id", "a.idcongviec", "cv.mota", "a.ngaynopbai", "cv.ngayhoanthanh", "a.manv");

	$sIndexColumn = "cv.id";
	
	/* DB table to use */
	$sTable = "approvecongviec a inner join congvieccongtac cv on a.idcongviec = cv.id";
	 ...
	 */
	$sWhere = "where a.trangthai = ".STATUS_DEFAULT;
