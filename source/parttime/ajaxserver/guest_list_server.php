<?php
	...
	$aColumns = array( 'khach.makhach', 'khach.hoten', 'nhomkhach.tennhom', 
                       ...
                       'khach.dienthoai1',
                       'khach.tiemnang',
                       'SUM(donhang.thanhtien) AS doanhso',
                       'khach.makhach',
                       'khach.quan', 'khach.tp',
                       'khach.dienthoai2', 'khach.dienthoai3',
                     );
	...
	/* DB table to use */
	$sTable = "khach INNER JOIN nhomkhach ON khach.manhom = nhomkhach.manhom
    ...
    {
        $tmpQuery = sprintf(" (khach.manhom = '%s') ", $nhomkhach);
    }
	$sWhere = "";
	if ( isset($_GET['sSearch']) && $_GET['sSearch'] != "" )
	{
		...
		{
            $column = $aColumns[$i];
            if($column != 'SUM(donhang.thanhtien) AS doanhso')
