<?php
    ...
    $aColumns = array( 'l.uid',         //0
                       'n1.hoten hoten1',     //1: worker
                       'l.old_date',    //2 
                       'l.new_date',    //3
                       'l.note',        //4
                       'n2.hoten hoten2'      //5: created_by
                     );
    ...
    /* DB table to use */
    $sTable = 'working_leave_days l INNER JOIN nhanvien n1 ON l.worker = n1.manv
                                    INNER JOIN nhanvien n2 ON l.worker = n2.manv';
    $sGroupBy = '';
    ...
    $additional = "(approved = '{$approved}') AND (old_date IS NOT NULL)";
