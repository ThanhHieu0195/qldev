...
// Authenticate
do_authenticate(G_FINANCE, F_IMPORT_RED_BILL, TRUE);
?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Thêm hóa đơn đỏ từ file excel</title>
            ...
            <div id="main-content">
                ...
                <div class="content-box column-left" style="width:100%">
                    <div class="content-box-header">
                        <h3>Thêm hóa đơn đỏ từ file excel</h3>
                    </div>
                    <div class="content-box-content">
                        <div class="tab-content default-tab">
                            <form action="../ajaxserver/hoadondoupload.php" method="post" enctype="multipart/form-data" target="hidden_upload">
                                <p>Link template: <a href="../excelfiles/tp_import_red_bill.xls" target="_blank">file</a></p>
                                <p>
