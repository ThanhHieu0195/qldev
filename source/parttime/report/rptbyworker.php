...
// Authenticate
do_authenticate(G_REPORT, F_REPORT_RPT_BY_WORKER, TRUE);
?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Tổng hợp theo thợ làm sản phẩm</title>
            ...
            <div id="main-content">
                ...
                <div class="content-box column-left" style="width:100%">
                    <div class="content-box-header">
                        <h3>Tổng hợp theo thợ làm sản phẩm</h3>
                    </div>
                                            ...
                                            <div id="demo">
                                                ...
                                                <table class="bordered" id="example">
                                                    ...
                                                    <tbody>
                                                        <?php 
                                                        $db = new database();
                                                        $db->setQuery("SELECT matho, hoten FROM tho ORDER BY hoten ASC");
                                                        $array = $db->loadAllRow();
                                                        
                                                        foreach ($array as $row) {
                                                            $dh = new donhang();
                                                            $revenue = $dh->tong_hop_theo_tho_lam_tranh($row['matho'], $year);
                                                            echo "<tr>";                                                            
                                                            echo sprintf("<td class='blue-text'>%s</td>", $row['hoten']);
