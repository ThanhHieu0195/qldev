...
// Authenticate
do_authenticate(G_MANAGER_BUILDING_1, F_LIST_BUILDING_WAIT_FOR_APPROVE, TRUE);
?>
    ...
    <script type="text/javascript">
          $(function() {
            var oTable = $('#example').dataTable( {
                "bProcessing": true,
                "bServerSide": true,
                "sAjaxSource": "../ajaxserver/list_building_server_wait_for_approve.php",
                "aoColumnDefs": [
                ...
                "fnRowCallback": function( nRow, aData, iDisplayIndex ) {
                    ...
                    $('td:eq(8)', nRow).html("<a href='detail_building_approve.php?token_id="+aData[0]+"' target='blank'>Chi tiết</a>");
                }
            });
        });
    </script>
