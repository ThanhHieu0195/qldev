...
<head>
    ...
    <?php require_once "detail_building/script.php"; ?>
</head>
<body>
<div id="body-wrapper">
    <?php
    ...
    <div id="main-content" style="display: table">
        ...
        <div class="content-box column-left" style="width:100%">
            ...
            <?php require_once "detail_building/part-detail-category.php"; ?>
        ...
        <!-- detail material -->
        <?php require_once "detail_building/part-detail-material.php"; ?>
