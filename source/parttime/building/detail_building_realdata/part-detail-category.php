                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                        <thead>
                            <tr>
                                ...
                                <th class="num">Khối lượng DT</th>
                                <th class="num">Khối lượng TT</th>
                        ...
                        <?php
                           ...
                           foreach ($data_detail as $obj):
                                ...
                                $khoiluongthucte = "<input type='text' value='".$obj['khoiluongthucte']."' name='khoiluongthucte".$token."' placeholder='0' dongia='".$obj['dongiathdutoan']
                                                   ."' onkeyup='calautoExpectMoney(\"".$token."\",\"khoiluongthucte\", \"dudoanchiphibandau\" )'>";
                                ...
                                $row = "<tr id='row_$token'> <td class='index'>$i</td>
                                        ...
                                        <td>$ngaydukienbatdau</td> <td>$ngaydukienketthuc</td><td>$khoiluongdutoan</td>
                                        <td>$khoiluongthucte</td> <td>$dongiathdutoan</td>
