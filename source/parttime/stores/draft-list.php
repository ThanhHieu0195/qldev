...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Danh sách phiếu chuyển hàng đã tạo</title>
        ...
        <script type="text/javascript" charset="utf-8">
            $(function() {
                var oTable = $('#example').dataTable( {
                    ...
                    "bServerSide": true,
                    "bPaginate": true,
                    "sAjaxSource": "../ajaxserver/items_swapping_draft_list_server.php",
                    "aaSorting": [[ 6, "asc" ]],
                    "aoColumnDefs": [
        ...
        <div id="body-wrapper">
            ...
            <div id="main-content">
                ...
                <ul class="shortcut-buttons-set">
                    <li>
                        <a class="shortcut-button new-page current" href="../stores/draft-list.php">
                ...
                <div class="content-box column-left" style="width:100%">
                    <div class="content-box-header">
                        <h3>Danh sách phiếu chuyển hàng đã tạo</h3>
                    </div>
